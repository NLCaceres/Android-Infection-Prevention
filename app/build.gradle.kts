...
dependencies {
    ...
    implementation("androidx.fragment:fragment-ktx:1.5.4") // SO need to add "-ktx" Kotlin versions!
    ...
    testImplementation("androidx.test.espresso:espresso-core:3.5.0") // For robolectric UI-Unit testing
    ...
    implementation("androidx.test.espresso:espresso-idling-resource:3.5.0") // To insert EspressoTestIdler into debug versions of app files
